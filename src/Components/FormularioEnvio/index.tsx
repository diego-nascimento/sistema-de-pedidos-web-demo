...
import { BotaoFinalizar } from '../Carrinho/style';
...
const FormularioEnvio: React.FC<FormularioEnvioProps> = ({ disabled, produtos }) =>{
  ...
  async function ConcluirPedido(e: React.ChangeEvent) {
    e.preventDefault();
  ...
  return (
    <Formulario onSubmit={() => ConcluirPedido}>
      ...
      <textarea
        placeholder="Alguma duvida ou algo mais a informar?"
        value={observacao}
        required
